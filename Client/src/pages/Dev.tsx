...
export default function Dev() {
  return (
    <div className="p-12 flex flex-col items-center justify-center bg-zinc-100">
        <h1 className="p-6 font-bold text-2xl text-sky-600">Developing The Paytrack App</h1>
        <div className="p-6 flex flex-col justify-start items-center">
          ...
          <div>
            ...
            <p className="text-lg p-2">
              I created an Express JS server to power the back end. The server interacts with a Mongodb database for storing user data. For the custom authentication I used JSON web tokens along with cookies and encryption methods. 
            </p>
          </div>
        </div>
        <div className="p-6 flex flex-col justify-start items-center">
