...
export default function Navbar() {
  return (
    <div className='flex flex-row flex-wrap justify-between md:justify-normal p-1 w-screen  bg-gray-950'>
            <svg className="mx-auto my-2 md:m-2" width="160px" height="60px" viewBox="0 0 412 129" fill="none" xmlns="http://www.w3.org/2000/svg">
